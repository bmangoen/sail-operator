...
skipInDryRun ! git config --global user.name && git config --global user.name "${GIT_CONFIG_USER_NAME}"
skipInDryRun ! git config --global user.email && git config --global user.email "${GIT_CONFIG_USER_EMAIL}"
